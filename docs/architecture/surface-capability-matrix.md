...
| `inspect-cells` | _(none today)_ | SHARED_PARTIAL | `core.read.inspect_cells` (planned) | later | CLI-only surface now | `crates/spreadsheet-kit/src/cli/commands/read.rs::inspect_cells` | `crates/spreadsheet-kit/tests/cli_integration.rs` |
