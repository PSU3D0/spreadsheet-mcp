...
use spreadsheet_kit::config::{OutputProfile, ServerConfig, TransportKind};
use spreadsheet_kit::state::AppState;
...
impl TestWorkspace {
    ...
    pub fn config(&self) -> ServerConfig {
        ServerConfig {
            ...
            recalc_backend: spreadsheet_kit::config::RecalcBackendKind::Auto,
            vba_enabled: false,
